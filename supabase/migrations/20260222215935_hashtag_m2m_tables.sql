...
alter table "public"."amendment_support_vote" enable row level security;
  ...
  create table "public"."amendment_vote" (
    "id" uuid not null default gen_random_uuid(),
    "amendment_id" uuid not null,
    "user_id" uuid not null,
    "event_id" uuid,
...
alter table "public"."amendment_vote_entry" enable row level security;
  ...
  create table "public"."amendment_voting_session" (
    "id" uuid not null default gen_random_uuid(),
    "amendment_id" uuid not null,
    "event_id" uuid,
    "title" text,
...
alter table "public"."amendment_voting_session" enable row level security;
  ...
  create table "public"."amendment_voting_session_vote" (
    "id" uuid not null default gen_random_uuid(),
...
alter table "public"."event_vote" enable row level security;
  ...
  create table "public"."event_voting_session" (
    "id" uuid not null default gen_random_uuid(),
    "event_id" uuid not null,
    "agenda_item_id" uuid,
    "title" text,
...
alter table "public"."role" enable row level security;
  ...
  create table "public"."scheduled_election" (
    "id" uuid not null default gen_random_uuid(),
    "event_id" uuid not null,
    "position_id" uuid,
    "title" text,
...
CREATE UNIQUE INDEX amendment_vote_pkey ON public.amendment_vote USING btree (id);

CREATE UNIQUE INDEX amendment_voting_session_pkey ON public.amendment_voting_session USING btree (id);

CREATE UNIQUE INDEX amendment_voting_session_vote_pkey ON public.amendment_voting_session_vote USING btree (id);
...
CREATE UNIQUE INDEX election_vote_pkey ON public.election_vote USING btree (id);
...
CREATE UNIQUE INDEX event_vote_pkey ON public.event_vote USING btree (id);

CREATE UNIQUE INDEX event_voting_session_pkey ON public.event_voting_session USING btree (id);
...
CREATE INDEX idx_amendment_vote_amendment ON public.amendment_vote USING btree (amendment_id);
...
CREATE INDEX idx_amendment_vote_user ON public.amendment_vote USING btree (user_id);

CREATE INDEX idx_amendment_voting_session_amendment ON public.amendment_voting_session USING btree (amendment_id);

CREATE INDEX idx_amendment_voting_session_vote_session ON public.amendment_voting_session_vote USING btree (session_id);

CREATE INDEX idx_amendment_voting_session_vote_user ON public.amendment_voting_session_vote USING btree (user_id);
...
CREATE INDEX idx_election_vote_candidate ON public.election_vote USING btree (candidate_id);

CREATE INDEX idx_election_vote_election ON public.election_vote USING btree (election_id);

CREATE INDEX idx_election_vote_voter ON public.election_vote USING btree (voter_id);
...
CREATE INDEX idx_event_vote_session ON public.event_vote USING btree (session_id);

CREATE INDEX idx_event_vote_user ON public.event_vote USING btree (user_id);

CREATE INDEX idx_event_voting_session_event ON public.event_voting_session USING btree (event_id);
...
CREATE INDEX idx_scheduled_election_event ON public.scheduled_election USING btree (event_id);
...
CREATE UNIQUE INDEX scheduled_election_pkey ON public.scheduled_election USING btree (id);
...
alter table "public"."amendment_vote" add constraint "amendment_vote_pkey" PRIMARY KEY using index "amendment_vote_pkey";
...
alter table "public"."amendment_voting_session" add constraint "amendment_voting_session_pkey" PRIMARY KEY using index "amendment_voting_session_pkey";

alter table "public"."amendment_voting_session_vote" add constraint "amendment_voting_session_vote_pkey" PRIMARY KEY using index "amendment_voting_session_vote_pkey";
...
alter table "public"."election_vote" add constraint "election_vote_pkey" PRIMARY KEY using index "election_vote_pkey";
...
alter table "public"."event_vote" add constraint "event_vote_pkey" PRIMARY KEY using index "event_vote_pkey";

alter table "public"."event_voting_session" add constraint "event_voting_session_pkey" PRIMARY KEY using index "event_voting_session_pkey";
...
alter table "public"."scheduled_election" add constraint "scheduled_election_pkey" PRIMARY KEY using index "scheduled_election_pkey";
...
alter table "public"."amendment_vote" add constraint "amendment_vote_amendment_id_fkey" FOREIGN KEY (amendment_id) REFERENCES public.amendment(id) ON DELETE CASCADE not valid;

alter table "public"."amendment_vote" validate constraint "amendment_vote_amendment_id_fkey";

alter table "public"."amendment_vote" add constraint "amendment_vote_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public."user"(id) ON DELETE CASCADE not valid;

alter table "public"."amendment_vote" validate constraint "amendment_vote_user_id_fkey";
...
alter table "public"."amendment_voting_session" add constraint "amendment_voting_session_amendment_id_fkey" FOREIGN KEY (amendment_id) REFERENCES public.amendment(id) ON DELETE CASCADE not valid;

alter table "public"."amendment_voting_session" validate constraint "amendment_voting_session_amendment_id_fkey";

alter table "public"."amendment_voting_session_vote" add constraint "amendment_voting_session_vote_session_id_fkey" FOREIGN KEY (session_id) REFERENCES public.amendment_voting_session(id) ON DELETE CASCADE not valid;

alter table "public"."amendment_voting_session_vote" validate constraint "amendment_voting_session_vote_session_id_fkey";

alter table "public"."amendment_voting_session_vote" add constraint "amendment_voting_session_vote_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public."user"(id) ON DELETE CASCADE not valid;

alter table "public"."amendment_voting_session_vote" validate constraint "amendment_voting_session_vote_user_id_fkey";
...
alter table "public"."election_vote" add constraint "election_vote_candidate_id_fkey" FOREIGN KEY (candidate_id) REFERENCES public.election_candidate(id) ON DELETE CASCADE not valid;

alter table "public"."election_vote" validate constraint "election_vote_candidate_id_fkey";

alter table "public"."election_vote" add constraint "election_vote_election_id_fkey" FOREIGN KEY (election_id) REFERENCES public.election(id) ON DELETE CASCADE not valid;

alter table "public"."election_vote" validate constraint "election_vote_election_id_fkey";

alter table "public"."election_vote" add constraint "election_vote_voter_id_fkey" FOREIGN KEY (voter_id) REFERENCES public."user"(id) ON DELETE CASCADE not valid;

alter table "public"."election_vote" validate constraint "election_vote_voter_id_fkey";
...
alter table "public"."event_vote" add constraint "event_vote_session_id_fkey" FOREIGN KEY (session_id) REFERENCES public.event_voting_session(id) ON DELETE CASCADE not valid;

alter table "public"."event_vote" validate constraint "event_vote_session_id_fkey";

alter table "public"."event_vote" add constraint "event_vote_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public."user"(id) ON DELETE CASCADE not valid;

alter table "public"."event_vote" validate constraint "event_vote_user_id_fkey";

alter table "public"."event_voting_session" add constraint "event_voting_session_event_id_fkey" FOREIGN KEY (event_id) REFERENCES public.event(id) ON DELETE CASCADE not valid;

alter table "public"."event_voting_session" validate constraint "event_voting_session_event_id_fkey";
...
alter table "public"."scheduled_election" add constraint "scheduled_election_event_id_fkey" FOREIGN KEY (event_id) REFERENCES public.event(id) ON DELETE CASCADE not valid;

alter table "public"."scheduled_election" validate constraint "scheduled_election_event_id_fkey";
...
alter table "public"."user_stats" add constraint "user_stats_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public."user"(id) ON DELETE CASCADE not valid;
...
grant delete on table "public"."amendment_vote" to "anon";

grant insert on table "public"."amendment_vote" to "anon";

grant references on table "public"."amendment_vote" to "anon";

grant select on table "public"."amendment_vote" to "anon";

grant trigger on table "public"."amendment_vote" to "anon";

grant truncate on table "public"."amendment_vote" to "anon";

grant update on table "public"."amendment_vote" to "anon";

grant delete on table "public"."amendment_vote" to "authenticated";

grant insert on table "public"."amendment_vote" to "authenticated";

grant references on table "public"."amendment_vote" to "authenticated";

grant select on table "public"."amendment_vote" to "authenticated";

grant trigger on table "public"."amendment_vote" to "authenticated";

grant truncate on table "public"."amendment_vote" to "authenticated";

grant update on table "public"."amendment_vote" to "authenticated";

grant delete on table "public"."amendment_vote" to "service_role";

grant insert on table "public"."amendment_vote" to "service_role";

grant references on table "public"."amendment_vote" to "service_role";

grant select on table "public"."amendment_vote" to "service_role";

grant trigger on table "public"."amendment_vote" to "service_role";

grant truncate on table "public"."amendment_vote" to "service_role";

grant update on table "public"."amendment_vote" to "service_role";
...
grant delete on table "public"."amendment_voting_session" to "anon";

grant insert on table "public"."amendment_voting_session" to "anon";

grant references on table "public"."amendment_voting_session" to "anon";

grant select on table "public"."amendment_voting_session" to "anon";

grant trigger on table "public"."amendment_voting_session" to "anon";

grant truncate on table "public"."amendment_voting_session" to "anon";

grant update on table "public"."amendment_voting_session" to "anon";

grant delete on table "public"."amendment_voting_session" to "authenticated";

grant insert on table "public"."amendment_voting_session" to "authenticated";

grant references on table "public"."amendment_voting_session" to "authenticated";

grant select on table "public"."amendment_voting_session" to "authenticated";

grant trigger on table "public"."amendment_voting_session" to "authenticated";

grant truncate on table "public"."amendment_voting_session" to "authenticated";

grant update on table "public"."amendment_voting_session" to "authenticated";

grant delete on table "public"."amendment_voting_session" to "service_role";

grant insert on table "public"."amendment_voting_session" to "service_role";

grant references on table "public"."amendment_voting_session" to "service_role";

grant select on table "public"."amendment_voting_session" to "service_role";

grant trigger on table "public"."amendment_voting_session" to "service_role";

grant truncate on table "public"."amendment_voting_session" to "service_role";

grant update on table "public"."amendment_voting_session" to "service_role";

grant delete on table "public"."amendment_voting_session_vote" to "anon";

grant insert on table "public"."amendment_voting_session_vote" to "anon";

grant references on table "public"."amendment_voting_session_vote" to "anon";

grant select on table "public"."amendment_voting_session_vote" to "anon";

grant trigger on table "public"."amendment_voting_session_vote" to "anon";

grant truncate on table "public"."amendment_voting_session_vote" to "anon";

grant update on table "public"."amendment_voting_session_vote" to "anon";

grant delete on table "public"."amendment_voting_session_vote" to "authenticated";

grant insert on table "public"."amendment_voting_session_vote" to "authenticated";

grant references on table "public"."amendment_voting_session_vote" to "authenticated";

grant select on table "public"."amendment_voting_session_vote" to "authenticated";

grant trigger on table "public"."amendment_voting_session_vote" to "authenticated";

grant truncate on table "public"."amendment_voting_session_vote" to "authenticated";

grant update on table "public"."amendment_voting_session_vote" to "authenticated";

grant delete on table "public"."amendment_voting_session_vote" to "service_role";

grant insert on table "public"."amendment_voting_session_vote" to "service_role";

grant references on table "public"."amendment_voting_session_vote" to "service_role";

grant select on table "public"."amendment_voting_session_vote" to "service_role";

grant trigger on table "public"."amendment_voting_session_vote" to "service_role";

grant truncate on table "public"."amendment_voting_session_vote" to "service_role";

grant update on table "public"."amendment_voting_session_vote" to "service_role";
...
grant delete on table "public"."election_vote" to "anon";

grant insert on table "public"."election_vote" to "anon";

grant references on table "public"."election_vote" to "anon";

grant select on table "public"."election_vote" to "anon";

grant trigger on table "public"."election_vote" to "anon";

grant truncate on table "public"."election_vote" to "anon";

grant update on table "public"."election_vote" to "anon";

grant delete on table "public"."election_vote" to "authenticated";

grant insert on table "public"."election_vote" to "authenticated";

grant references on table "public"."election_vote" to "authenticated";

grant select on table "public"."election_vote" to "authenticated";

grant trigger on table "public"."election_vote" to "authenticated";

grant truncate on table "public"."election_vote" to "authenticated";

grant update on table "public"."election_vote" to "authenticated";

grant delete on table "public"."election_vote" to "service_role";

grant insert on table "public"."election_vote" to "service_role";

grant references on table "public"."election_vote" to "service_role";

grant select on table "public"."election_vote" to "service_role";

grant trigger on table "public"."election_vote" to "service_role";

grant truncate on table "public"."election_vote" to "service_role";

grant update on table "public"."election_vote" to "service_role";
...
grant delete on table "public"."event_vote" to "anon";

grant insert on table "public"."event_vote" to "anon";

grant references on table "public"."event_vote" to "anon";

grant select on table "public"."event_vote" to "anon";

grant trigger on table "public"."event_vote" to "anon";

grant truncate on table "public"."event_vote" to "anon";

grant update on table "public"."event_vote" to "anon";

grant delete on table "public"."event_vote" to "authenticated";

grant insert on table "public"."event_vote" to "authenticated";

grant references on table "public"."event_vote" to "authenticated";

grant select on table "public"."event_vote" to "authenticated";

grant trigger on table "public"."event_vote" to "authenticated";

grant truncate on table "public"."event_vote" to "authenticated";

grant update on table "public"."event_vote" to "authenticated";

grant delete on table "public"."event_vote" to "service_role";

grant insert on table "public"."event_vote" to "service_role";

grant references on table "public"."event_vote" to "service_role";

grant select on table "public"."event_vote" to "service_role";

grant trigger on table "public"."event_vote" to "service_role";

grant truncate on table "public"."event_vote" to "service_role";

grant update on table "public"."event_vote" to "service_role";

grant delete on table "public"."event_voting_session" to "anon";

grant insert on table "public"."event_voting_session" to "anon";

grant references on table "public"."event_voting_session" to "anon";

grant select on table "public"."event_voting_session" to "anon";

grant trigger on table "public"."event_voting_session" to "anon";

grant truncate on table "public"."event_voting_session" to "anon";

grant update on table "public"."event_voting_session" to "anon";

grant delete on table "public"."event_voting_session" to "authenticated";

grant insert on table "public"."event_voting_session" to "authenticated";

grant references on table "public"."event_voting_session" to "authenticated";

grant select on table "public"."event_voting_session" to "authenticated";

grant trigger on table "public"."event_voting_session" to "authenticated";

grant truncate on table "public"."event_voting_session" to "authenticated";

grant update on table "public"."event_voting_session" to "authenticated";

grant delete on table "public"."event_voting_session" to "service_role";

grant insert on table "public"."event_voting_session" to "service_role";

grant references on table "public"."event_voting_session" to "service_role";

grant select on table "public"."event_voting_session" to "service_role";

grant trigger on table "public"."event_voting_session" to "service_role";

grant truncate on table "public"."event_voting_session" to "service_role";

grant update on table "public"."event_voting_session" to "service_role";
...
grant delete on table "public"."scheduled_election" to "anon";

grant insert on table "public"."scheduled_election" to "anon";

grant references on table "public"."scheduled_election" to "anon";

grant select on table "public"."scheduled_election" to "anon";

grant trigger on table "public"."scheduled_election" to "anon";

grant truncate on table "public"."scheduled_election" to "anon";

grant update on table "public"."scheduled_election" to "anon";

grant delete on table "public"."scheduled_election" to "authenticated";

grant insert on table "public"."scheduled_election" to "authenticated";

grant references on table "public"."scheduled_election" to "authenticated";

grant select on table "public"."scheduled_election" to "authenticated";

grant trigger on table "public"."scheduled_election" to "authenticated";

grant truncate on table "public"."scheduled_election" to "authenticated";

grant update on table "public"."scheduled_election" to "authenticated";

grant delete on table "public"."scheduled_election" to "service_role";

grant insert on table "public"."scheduled_election" to "service_role";

grant references on table "public"."scheduled_election" to "service_role";

grant select on table "public"."scheduled_election" to "service_role";

grant trigger on table "public"."scheduled_election" to "service_role";

grant truncate on table "public"."scheduled_election" to "service_role";

grant update on table "public"."scheduled_election" to "service_role";
...
using (true);
  ...
  create policy "service_role_all"
  on "public"."amendment_voting_session"
  as permissive
  for all
  to service_role
using (true);
  ...
  create policy "service_role_all"
  on "public"."amendment_voting_session_vote"
  as permissive
  for all
  to service_role
using (true);
...
using (true);
  ...
  create policy "service_role_all"
  on "public"."event_voting_session"
  as permissive
  for all
  to service_role
using (true);
