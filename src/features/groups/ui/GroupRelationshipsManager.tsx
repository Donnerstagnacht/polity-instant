...
import { useGroupData } from '@/features/groups/hooks/useGroupData.ts';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/features/shared/ui/ui/card.tsx';
import { PermissionGuard } from '@/features/auth/PermissionGuard.tsx';
...
import {
  ...
  TableHeader,
  TableRow,
} from '@/features/shared/ui/ui/table.tsx';
import { useGroupNetwork } from '@/features/network/hooks/useGroupNetwork.ts';
...
import { RIGHT_TYPES } from '@/features/network/ui/RightFilters.tsx';
import { RightBadge } from '@/features/network/ui/RightBadge.tsx';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
import { useGroupActions } from '@/zero/groups/useGroupActions.ts';
        ...
        <CardContent className="space-y-6">
                        ...
                        <div className="flex gap-2">
                          ...
                          >
                            <Button
                              size="sm"
                              variant="outline"
                              onClick={() => handleRejectRequest(req.rels)}
                            >
                              {t('common.network.reject')}
                            </Button>
                            <Button size="sm" onClick={() => handleAcceptRequest(req.rels)}>
          ...
          <div className="mb-6 flex flex-col gap-4 md:flex-row">
            ...
            <div className="flex gap-2">
              ...
              >
                {showIndirect
                  ? t('common.network.indirectIncluded')
                  : t('common.network.directOnly')}
              </Button>
            </div>
          </div>
