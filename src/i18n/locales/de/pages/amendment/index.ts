export const amendmentPageTranslations = {
  ...
  changeRequests: {
    ...
    noChangeRequests: 'Keine Änderungsanträge gefunden',
  ...
  process: {
    ...
    description: 'Navigiere durch das Netzwerk, um eine Zielgruppe und Veranstaltung für deinen Antrag auszuwählen',
  },
  notifications: {
